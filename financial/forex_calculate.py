def calculate_profit():
    ...
    try:
        raw_input = input(f"Enter the total amount used to buy the product ({currency}): ")
        ...
        print(f"{'=' * 44}")
        print(f"{'Cost per unit:':<{col_label}}{f'{unit_cost:,.2f} {currency}':>{col_val}}")
        print(f"{'Selling price per unit:':<{col_label}}{f'{unit_selling_price:,.2f} {currency}':>{col_val}}")
        print(f"{'Profit per unit:':<{col_label}}{f'{profit_per_unit:,.2f} {currency}':>{col_val}}")
        print(f"{'Units purchased:':<{col_label}}{f'{units_bought:,.2f}':>{col_val}}")
        ...
        print(f"{'-' * 44}")
        print(f"{'Exchange rate:':<{col_label}}{f'{exchange_rate:,.0f} {currency} = $1':>{col_val}}")
